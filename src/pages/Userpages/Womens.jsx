...
const Womens = () => {
  return (
    <>
    <div className="p-4 mx-auto lg:max-w-6xl md:max-w-3xl sm:max-w-full font-poppins">
      <h2 className="text-4xl font-extrabold text-gray-800 mb-12">Womens Collection</h2>

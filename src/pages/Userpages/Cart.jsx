        ...
        <div className="grid md:grid-cols-3 gap-4 shadow-lg">
          ...
          <div className="bg-gray-100 rounded-md p-4 md:sticky top-0">
            <div className="flex border border-blue-600 overflow-hidden rounded-md">
              ...
              <button type="button" className="flex items-center justify-center font-semibold tracking-wide bg-blue-950 hover:bg-blue-900 px-4 text-sm text-white">
                Apply
              </button>
            </div>
            ...
            <div className="mt-8 space-y-2">
              <button type="button" className="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-blue-950 hover:bg-blue-900 text-white rounded-md">
                Checkout
              </button>

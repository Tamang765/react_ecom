...
const ProductDetail = () => {
  ...
  return (
    <>
      <div className="py-4 mx-auto lg:w-[95%] md:w-[95%] sm:w-[95%] w-[95%] max-w-7xl max-lg:mx-auto font-poppins mt-4">
              ...
              <div className="flex flex-wrap gap-4 items-start">
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-2">
                    <strike>Rs. 1500</strike> <span className="text-sm ml-1">Original Price</span>
                  </p>
                </div>
      ...
      <section className="sale-section w-[95%]  lg:w-[90%] md:w-[90%] sm:w-[95%] mx-auto max-w-7xl">
        <div className="card-section mt-16">
          <Heading text="You Might Also Like" />
          <div className="slider mt-7">
            <MultipleItems items={Products.slice(0,6)} />
          </div>
        </div>

        <div className="card-section my-16">

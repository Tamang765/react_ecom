...
const ProductDetail = () => {
  return (
    <>
      <div className=" p-4 mx-auto lg:w-[90%] md:w-[95%] sm:w-[95%] max-w-7xl  max-lg:mx-auto font-poppins mt-4">
        <div className="grid items-start grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-8 max-lg:gap-16">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 items-start">
              <div>
                <p className="text-gray-800 text-4xl font-bold">Rs. 1200</p>
                <p className="text-gray-500 text-sm mt-2">
                  <strike>Rs. 1500</strike> <span className="text-sm ml-1">Orignal Price</span>
                </p>
              </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 mt-4">
                <button type="button" className="w-10 h-10 border hover:border-gray-800 font-semibold text-sm rounded-md flex items-center justify-center shrink-0">
                  SM
                </button>
                <button type="button" className="w-10 h-10 border hover:border-gray-800 border-gray-800 font-semibold text-sm rounded-md flex items-center justify-center shrink-0">
                  MD
                </button>
                <button type="button" className="w-10 h-10 border hover:border-gray-800 font-semibold text-sm rounded-md flex items-center justify-center shrink-0">
                  LG
        ...
        <div className="mt-20 max-w-4xl">
          <ul className="flex border-b">
            <li className="text-gray-800 font-semibold text-sm bg-gray-100 py-3 px-8 border-b-2 border-gray-800 cursor-pointer transition-all">Description</li>
      ...
      <section className="sale-section  w-[95%] my-10 lg:w-[90%] md:w-[90%] sm:w-[95%] mx-auto max-w-7xl">
        ...
        <div className="card-section mt-10 ">
          <Heading text="Recently viewed Products" />

...
const ProductDetail = () => {
  return (
    <>
            <div class=" p-4 mx-auto lg:max-w-6xl max-w-2xl max-lg:mx-auto font-poppins mt-4">
                <div class="grid items-start grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-8 max-lg:gap-16">
                    <div class="w-full lg:sticky top-0 text-center">
                        ...
                        <div class="flex flex-wrap gap-4 justify-center mx-auto mt-4">
                            <img src="https://readymadeui.com/images/product6.webp" alt="Product1" class="w-16 md:w-14 cursor-pointer rounded-md outline" />
                            <img src="https://readymadeui.com/images/product8.webp" alt="Product2" class="w-16 md:w-14 cursor-pointer rounded-md" />
                            <img src="https://readymadeui.com/images/product5.webp" alt="Product3" class="w-16 md:w-14 cursor-pointer rounded-md" />
                            <img src="https://readymadeui.com/images/product7.webp" alt="Product4" class="w-16 md:w-14 cursor-pointer rounded-md" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-4 items-start">
                            <div>
                                <p class="text-gray-800 text-4xl font-bold">Rs. 1200</p>
                                <p class="text-gray-500 text-sm mt-2"><strike>Rs. 1500</strike> <span class="text-sm ml-1">Orignal Price</span></p>
                            </div>
            ...
            <section className="sale-section my-10">
                 {/* also like  section start */}
        <div className="card-section ">
          <h2 className='uppercase italic font-extrabold text-2xl mb-4 text-center text-blue-950'>You Might Also Like</h2>
...
<button type="button" class="w-3 h-3 rounded-full bg-sky-400 hover:bg-teal-600" aria-current="false" aria-label="Slide 5" data-carousel-slide-to="4"></button>
        ...
        {/* also like section end */}
          ...
          <h2 className='uppercase italic font-extrabold text-2xl mb-4 text-center text-blue-950'>Recently viewed Products</h2>
          <div className="mx-auto mt-7 w-4/5 lg:w-5/6 max-w-screen-xl grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-y-4 md:gap-y-5 justify-items-center relative">
            <ProductCard />
            <ProductCard />
            <ProductCard />
